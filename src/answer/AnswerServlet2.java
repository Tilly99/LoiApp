...
/**
 * <code>AnswerServlet2</code>This servlet is using JDBC to Connect Tomcat to
 ...
 */
@WebServlet(name = "AnswerServlet2", urlPatterns = {"/AnswerServlet2"})
public class AnswerServlet2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AnswerServlet2.class.getName()).log(Level.SEVERE, null, ex);
        }
